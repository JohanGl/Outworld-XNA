...
namespace Framework.Animations.Pipeline
{
	...
	public class AnimationDefinition
	{
		...
		public class ClipPart
		{
			...
			/// <summary>
			/// Can be used to alter the animation speed of the clip where 1.0 is the default speed.
			/// Decreasing this value speeds things up while increasing it will slow things down.
			/// </summary>
